...
#[cfg(all(target_feature = "avx512vl", target_feature = "avx512bw", target_feature = "avx512vbmi2"))]
mod rays;
...
impl Network {
    ...
    cfg_select! {
        all(target_feature = "avx512vl", target_feature = "avx512bw", target_feature = "avx512vbmi2") => {
