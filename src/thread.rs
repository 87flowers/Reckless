...
pub struct ThreadData {
    ...
    pub conthist_low_ply_sentinel: [[i16; 64]; 13],
    pub contcorrhist_low_ply_sentinel: [[i16; 64]; 13],
    pub conthist_null_move_sentinel: [[i16; 64]; 13],
    pub contcorrhist_null_move_sentinel: [[i16; 64]; 13],
...
impl ThreadData {
    pub fn new(shared: Arc<SharedContext>) -> Self {
        Self {
            ...
            conthist_low_ply_sentinel: [[0; 64]; 13],
            contcorrhist_low_ply_sentinel: [[0; 64]; 13],
            conthist_null_move_sentinel: [[0; 64]; 13],
            contcorrhist_null_move_sentinel: [[0; 64]; 13],
            best_move_changes: 0,
            optimism: [0; 2],
            stopped: false,
            root_depth: 0,
