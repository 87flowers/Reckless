...
use crate::{
    board::Board,
    history::{
        ContinuationCorrectionHistory, ContinuationHistory, CorrectionHistory, HashHistory, NoisyHistory, QuietHistory,
    },
    nnue::Network,
...
impl ThreadData {
    pub fn new(shared: Arc<SharedContext>) -> Self {
        Self {
            ...
            pawn_history: HashHistory::default(),
