...
pub fn start(td: &mut ThreadData, report: Report, thread_count: usize) {
    ...
    let mut eval_last_unstable = 0;
    let mut pv_last_unstable = 0;
    ...
    for depth in 1..MAX_PLY as i32 {
        ...
        let multiplier = || {
            ...
            let pv_since_unstable = current_nodes - pv_last_unstable;
            let eval_since_unstable = current_nodes - eval_last_unstable;
            ...
            let pv_stability = (1.2881 - 0.00440 * (pv_since_unstable as f32).powf(0.303)).max(0.7160);

            let eval_stability = (1.2664 - 0.00416 * (eval_since_unstable as f32).powf(0.303)).max(0.8642);
